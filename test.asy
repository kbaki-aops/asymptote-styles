...
draw(circle(2E+0S, 0.4), spRedStroke);
...
fill(circle(2E+1S, 0.4), spRedFill);
...
filldraw(circle(2E+2S, 0.4), spRedFill, spRedStroke);
...
label("\strut{red}", 2E+3S, spRedFont+fontsize(24));
...
draw(shift(0E)*p, spBlue);
draw(shift(1E)*p, spBlue.stroke);
draw(shift(2E)*p, spStrokes[0]);
draw(shift(3E)*p, spColors[0]);

// two ways to fill

draw(shift(4E)*p, spBlue.fill);
